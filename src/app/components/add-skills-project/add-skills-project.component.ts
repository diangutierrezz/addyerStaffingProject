...
@Component({
  selector: 'app-add-skills-project',
  templateUrl: './add-skills-project.component.html',
  styleUrls: ['./add-skills-project.component.css']
})
export class AddSkillsProjectComponent implements OnInit {
